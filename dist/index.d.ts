...
export type PluginExecution = PluginInProcessExecution | PluginContainerExecution;
...
export declare function firstPartyFeature(slug: string, _version: string, options?: Partial<PluginInProcessExecution>): PluginInProcessExecution;
...
export type PluginSignalKind = "security.finding" | "policy.decision" | "approval.event" | "secret.detected" | "tool.risk" | "mcp.discovery" | "identity.risk" | "audit.event" | "plugin.health" | "export.status";
...
export declare const OPENLEASH_API_FUNCTION_HEADER = "x-openleash-api-function";
export declare const OPENLEASH_API_VERSION_HEADER = "x-openleash-api-version";
export declare const OPENLEASH_API_CONTRACTS: {
    readonly health: "2026-05-16.health.v1";
    readonly tenantEnroll: "2026-05-16.tenant-enroll.v1";
    readonly tenantEvaluate: "2026-05-16.tenant-evaluate.v1";
    readonly tenantHookEvaluate: "2026-05-22.tenant-hook-evaluate.v1";
    readonly tenantDecisionPoll: "2026-05-16.tenant-decision-poll.v1";
    readonly tenantDecisionResolve: "2026-05-16.tenant-decision-resolve.v1";
    readonly tenantTrayStatus: "2026-05-16.tenant-tray-status.v1";
    readonly tenantSkillObservation: "2026-05-27.tenant-skill-observation.v1";
    readonly tenantPluginsRead: "2026-06-20.tenant-plugins-read.v1";
    ...
    readonly adminPluginsRead: "2026-06-20.admin-plugins-read.v1";
    readonly adminPluginsWrite: "2026-06-20.admin-plugins-write.v1";
    readonly adminLogs: "2026-06-03.admin-logs.v1";
    readonly adminLogDetail: "2026-06-03.admin-log-detail.v1";
    readonly adminTriggers: "2026-05-16.admin-triggers.v1";
    readonly adminTriggerDetail: "2026-05-16.admin-trigger-detail.v1";
    readonly adminEventDetail: "2026-05-16.admin-event-detail.v1";
    readonly adminExternalAgents: "2026-05-16.admin-external-agents.v1";
    readonly adminExternalAgentsSync: "2026-05-16.admin-external-agents-sync.v1";
    readonly adminProviderUsageRead: "2026-06-09.admin-provider-usage-read.v1";
    readonly adminProviderUsageWrite: "2026-06-09.admin-provider-usage-write.v1";
    readonly adminProviderUsageSync: "2026-06-09.admin-provider-usage-sync.v1";
    readonly adminOnboardingRead: "2026-05-16.admin-onboarding-read.v1";
    readonly adminOnboardingWrite: "2026-05-16.admin-onboarding-write.v1";
    readonly adminIdentityRead: "2026-05-16.admin-identity-read.v1";
    readonly adminUsersWrite: "2026-05-16.admin-users-write.v1";
    readonly adminDeploymentTokensRead: "2026-05-16.admin-deployment-tokens-read.v1";
    readonly adminDeploymentTokensWrite: "2026-05-16.admin-deployment-tokens-write.v1";
    readonly adminPoliciesRead: "2026-05-16.admin-policies-read.v1";
    readonly adminPoliciesWrite: "2026-05-16.admin-policies-write.v1";
    ...
    readonly authGoogleCallback: "2026-05-24.auth-google-callback.v1";
    readonly mobileBootstrap: "2026-05-22.mobile-bootstrap.v1";
    readonly mobileAuthStart: "2026-05-22.mobile-auth-start.v1";
    readonly mobileAuthExchange: "2026-05-22.mobile-auth-exchange.v1";
    readonly mobileModelKey: "2026-05-23.mobile-model-key.v1";
    readonly mobileDeviceRegister: "2026-05-22.mobile-device-register.v1";
    readonly mobileState: "2026-05-22.mobile-state.v1";
    readonly clientOverview: "2026-08-13.client-overview.v1";
    ...
    readonly clientUpdateCheck: "2026-05-16.client-update-check.v1";
    readonly clientUpdateLatest: "2026-05-16.client-update-latest.v1";
    readonly clientReleasePublish: "2026-05-16.client-release-publish.v1";
    readonly localEvaluate: "2026-05-16.local-evaluate.v1";
    readonly localHookEvaluate: "2026-05-22.local-hook-evaluate.v1";
};
...
export declare function apiContractFor(functionName: OpenLeashApiFunction): {
    functionName: "health" | "tenantEnroll" | "tenantEvaluate" | "tenantHookEvaluate" | "tenantDecisionPoll" | "tenantDecisionResolve" | "tenantTrayStatus" | "tenantSkillObservation" | "tenantPluginsRead" | "desktopEnroll" | "adminOverview" | "adminSecurity" | "adminOutcomes" | "adminMcpServers" | "adminMcpServerDetail" | "adminSkills" | "adminPluginsRead" | "adminPluginsWrite" | "adminLogs" | "adminLogDetail" | "adminTriggers" | "adminTriggerDetail" | "adminEventDetail" | "adminExternalAgents" | "adminExternalAgentsSync" | "adminProviderUsageRead" | "adminProviderUsageWrite" | "adminProviderUsageSync" | "adminOnboardingRead" | "adminOnboardingWrite" | "adminIdentityRead" | "adminUsersWrite" | "adminDeploymentTokensRead" | "adminDeploymentTokensWrite" | "adminPoliciesRead" | "adminPoliciesWrite" | "adminPromptTransformsRead" | "adminPromptTransformsWrite" | "authSession" | "authAccountOutcomes" | "authLogout" | "authSsoAuthorize" | "authSsoCallback" | "authGoogleCallback" | "mobileBootstrap" | "mobileAuthStart" | "mobileAuthExchange" | "mobileModelKey" | "mobileDeviceRegister" | "mobileState" | "clientOverview" | "mobileDecisionResolve" | "clientNotifications" | "clientEvents" | "clientDecisionResolve" | "sessionMonitoring" | "organizationsRead" | "organizationsWrite" | "organizationSsoProviders" | "clientUpdateCheck" | "clientUpdateLatest" | "clientReleasePublish" | "localEvaluate" | "localHookEvaluate";
...
export declare function parseMcpToolName(toolName?: string): Pick<McpToolCall, "serverName" | "toolName" | "fullToolName"> | undefined;
export declare function mcpToolCallFromEvent(event: OpenLeashEvent): McpToolCall | undefined;
export declare function redactMcpArguments(value: unknown, depth?: number): unknown;
export declare function summarizeMcpArguments(value: unknown): string;
